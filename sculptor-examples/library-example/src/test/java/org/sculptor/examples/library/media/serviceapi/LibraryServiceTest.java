...
public class LibraryServiceTest extends AbstractDbUnitJpaTests implements LibraryServiceTestBase {
	...
	public void testFindMediaByName() throws Exception {
		String title = "Pippi L�ngstrump i S�derhavet";
	...
	public void testDelete() throws Exception {
		...
		// @PreDelete is not working as expected, seems to be a bug in DataNucleus,
		...
		// TODO: @PreDelete is not working as expected, seems to be a bug in OpenJPA,
		// report to issue tracker
		if (JpaHelper.isJpaProviderOpenJpa(getEntityManager())
	...
	public void testFindByCondition() throws Exception {
		...
		List<ConditionalCriteria> wrongCondition = ConditionalCriteriaBuilder.criteriaFor(Library.class)
				.withProperty(LibraryProperties.media().version()).eq(1l).orderBy(LibraryProperties.name()).descending()
				.build();
	...
	public void testFindByConditionLazyFetch() throws Exception {
		...
		List<ConditionalCriteria> conditions = ConditionalCriteriaBuilder.criteriaFor(Library.class)
				.withProperty(LibraryProperties.version()).eq(1l).withProperty(LibraryProperties.media()).fetchEager()
