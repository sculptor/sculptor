...
public class RtCarrierMovementRepositoryImpl extends RtCarrierMovementRepositoryBase
		implements
	...
	public void storeCarrierMovementId(String cmId, String from, String to) {
		Map<Object, RtLocation> locations = getRtLocationRepository()
				.findByKeys(new HashSet<String>(Arrays.asList(from, to)));
