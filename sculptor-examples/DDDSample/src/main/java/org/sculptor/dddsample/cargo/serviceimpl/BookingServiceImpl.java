...
public class BookingServiceImpl extends BookingServiceImplBase {
	...
	public TrackingId bookNewCargo(ServiceContext ctx, UnLocode originCode, UnLocode destinationCode)
	...
	public List<Itinerary> requestPossibleRoutesForCargo(ServiceContext ctx, TrackingId trackingId)
	...
	public void assignCargoToRoute(ServiceContext ctx, TrackingId trackingId, Itinerary itinerary)
