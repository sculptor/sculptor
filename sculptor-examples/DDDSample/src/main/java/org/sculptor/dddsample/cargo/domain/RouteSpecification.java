...
/**
 *
 * Value object representing RouteSpecification. This class is responsible for
 * the domain object related business logic for RouteSpecification. Properties
 * and associations are implemented in the generated base class
 * {@link org.sculptor.dddsample.cargo.domain.RouteSpecificationBase}.
 */
public class RouteSpecification extends RouteSpecificationBase implements Specification<Itinerary> {
	private static final long serialVersionUID = 1L;

	/**
	 * Factory for creatig a route specification for a cargo, from cargo origin to
	 * cargo destination. Use for initial routing.
	 *
	 * @param cargo
	 *            cargo
	...
	RouteSpecification(DateTime arrivalDeadline, Location origin, Location destination) {
