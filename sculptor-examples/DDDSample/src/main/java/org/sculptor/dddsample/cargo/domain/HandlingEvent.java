...
/**
 *
 * Value object representing HandlingEvent. This class is responsible for the
 * domain object related business logic for HandlingEvent. Properties and
 * associations are implemented in the generated base class
 * {@link org.sculptor.dddsample.cargo.domain.HandlingEventBase}.
 */
...
public class HandlingEvent extends HandlingEventBase {
	...
	/**
	 * Comparator used to be able to sort HandlingEvents according to their
	 * completion time
	 */
	...
	public HandlingEvent(Cargo cargo, DateTime completionTime, DateTime registrationTime, Type type, Location location,
			CarrierMovement carrierMovement) {
		super(completionTime, registrationTime, type, carrierMovement, location, cargo);

		validateType();
	}

	HandlingEvent(DateTime completionTime, DateTime registrationTime, org.sculptor.dddsample.cargo.domain.Type type,
