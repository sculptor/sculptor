...
public class ItineraryTest {
	...
	public void testCargoOnTrack() throws Exception {
		...
		Itinerary itinerary = new Itinerary(Arrays.asList(
				...
				new Leg(new CarrierMovement(new CarrierMovementId("DEF"), ROTTERDAM, GOTHENBURG), ROTTERDAM,
						GOTHENBURG)));

		// Happy path
		HandlingEvent event = new HandlingEvent(cargo, new DateTime(), new DateTime(), Type.RECEIVE, SHANGHAI, null);
