...
/**
 * Base class tests in a <a href="http://openejb.apache.org/">OpenEJB</a>
 * environment.
 * <p>
 ...
 * <code>/openejb-test.properties</code>. In case you need to destroy the
 * container after each test (class) you should add property
 * <code>openejb.embedded.initialcontext.close=destroy</code>. It is possible to
 * override persistent unit properties this way also.
 * <p>
 * More information:
 * <ul>
 * <li><a href=
 * "http://openejb.apache.org/embedded-configuration.html">http://openejb.apache.org/embedded-configuration.html</a>
 * <li><a href=
 * "http://openejb.apache.org/properties-listing.html">http://openejb.apache.org/properties-listing.html</a>
 * <li><a href=
 * "http://openejb.apache.org/configuring-logging-in-tests.html">http://openejb.apache.org/configuring-logging-in-tests.html</a>
 * </ul>
 * 
...
public abstract class AbstractOpenEJBTest {
	...
	/**
	 * possible to override to include more, or change, InitialContext Properties
	 */
