...
public class EnumHelper {
	...
	public static boolean isIdentifierAttributeOfTypeString(Class<? extends Enum<?>> enumClass) {
		if (enumClass == null) {
			return false;
		}
		try {
			...
			for (Method method : methods) {
				if (method.getName().startsWith("from") && method.getReturnType().equals(enumClass)) {
