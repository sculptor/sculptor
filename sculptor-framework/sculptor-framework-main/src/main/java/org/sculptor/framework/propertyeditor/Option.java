...
/**
 * Options are used in select lists. It is a simple holder for a DomainObject
...
public class Option<T> implements java.io.Serializable {
	...
	/**
	 * Factory method to create a list of Options from a list of DomainObjects. It
	 * is expected that the DomainObjects has
	 */
