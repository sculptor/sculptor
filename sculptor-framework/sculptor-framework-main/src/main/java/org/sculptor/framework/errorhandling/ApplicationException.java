 ...
 * <li>Request to fetch an entity, but there is no entity with specified
 * id.</li>
 * </ul>
 *
...
public class ApplicationException extends Exception {
	 ...
	 *            Array of message parameters. Usually used as parameters for
	 *            generating i18n messages from errorCode.
	 */
	...
	/**
	 * Well defined error code for the error type. Used in logs and for translation
	 * to user messages.
	 */
	...
	/**
	 * This method returns an array that contains objects that can be converted to
	 * String objects and inserted into the error message.
	 *
	 ...
	 * <p>
	 *
	 * Overrides the method in {@link Throwable} to allow for parameter insertion.
	 * If parameter insertion fails though, the message is returned without
	 * parameters inserted into the message String.
	 *
