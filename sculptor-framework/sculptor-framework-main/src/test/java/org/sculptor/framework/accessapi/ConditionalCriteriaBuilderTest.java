...
public class ConditionalCriteriaBuilderTest {
	...
	public void testLongPathElements() {
		ConditionalCriteria criteria = criteriaFor(Person.class)
				.withProperty(PersonProperties.boss().boss().boss().aaa()).eq(1234).buildSingle();
	...
	public void shouldBuildNestedProperties() {
		ConditionalCriteria criteria = criteriaFor(Person.class).withProperty(PersonProperties.primaryAddress().city())
	...
	public void shouldBuildWithStaticImportProperty() {
		// import static
		// org.sculptor.framework.accessapi.ConditionalCriteriaBuilderTest.Person.PersonProperties.primaryAddress;
		ConditionalCriteria criteria = criteriaFor(Person.class).withProperty(primaryAddress().city()).eq("Stockholm")
				.buildSingle();
	...
	public void shouldBuildWithEqObjectProperty() {
		ConditionalCriteria criteria = criteriaFor(Person.class).withProperty(primaryAddress())
				.eq(new Address("Kungsgatan 10", "Stockholm")).buildSingle();
	...
	public void shouldBuildSimpleBetweenCondition() {
		ConditionalCriteria criteria = criteriaFor(Person.class).withProperty(aaa()).between(1234, 6789).buildSingle();
	...
	public void shouldBuildEqualsPropertyCondition() {
		ConditionalCriteria criteria = criteriaFor(Person.class).withProperty(PersonProperties.aaa())
				.eq(PersonProperties.bbb()).buildSingle();
	...
	public void shouldBuildAndConditionWithoutAndKeyword() {
		ConditionalCriteria criteria = criteriaFor(Person.class).withProperty(aaa()).eq(1234).withProperty(bbb())
				.eq("zzz").buildSingle();
	...
	public void shouldBuildSingleListOfConditions() {
		ConditionalCriteria criteriaS = criteriaFor(Person.class).withProperty(aaa()).eq(1234).and().withProperty(bbb())
				.eq("zzz").and().withProperty(ccc()).eq("xxx").buildSingle();
	...
	public void shouldBuildListOfConditions() {
		List<ConditionalCriteria> criteria = criteriaFor(Person.class).withProperty(aaa()).eq(1234).and()
				.withProperty(bbb()).eq("zzz").and().withProperty(ccc()).eq("xxx").build();
	...
	public void shouldBuildEqualsWithOrderBy() {
		List<ConditionalCriteria> criteriaList = criteriaFor(Person.class).withProperty(aaa()).eq(1234)
				.withProperty(bbb()).eq("qqq").orderBy(ccc()).ascending().build();
	...
	public void shouldBuildOrConditionWithBraces() {
		ConditionalCriteria criteria = criteriaFor(Person.class).lbrace().withProperty(aaa()).eq(1234).or()
				.withProperty(bbb()).eq("zzz").rbrace().buildSingle();
	...
	public void shouldBuildMultipleEmptyBraces() {
		ConditionalCriteria criteria = criteriaFor(Person.class).lbrace().lbrace().lbrace().rbrace().rbrace().rbrace()
				.buildSingle();
		assertNull(criteria);
	}
	...
	public void shouldBuildUngroupedAndOr() {
		ConditionalCriteria criteria = criteriaFor(Person.class).withProperty(aaa()).eq("A").and().withProperty(bbb())
				.eq("B").or().withProperty(ccc()).eq("C").buildSingle();
	...
	public void shouldBuildUngroupedNotAndOr() {
		ConditionalCriteria criteria = criteriaFor(Person.class).withProperty(aaa()).eq("A").and().not()
				.withProperty(bbb()).eq("B").or().withProperty(ccc()).eq("C").buildSingle();
	...
	public void shouldBuildGroupedAndOr1() {
		ConditionalCriteria criteria = criteriaFor(Person.class).withProperty(aaa()).eq("A").and().lbrace()
				.withProperty(bbb()).eq("B").or().withProperty(ccc()).eq("C").rbrace().buildSingle();
	...
	public void shouldBuildGroupedAndOr1Implicit() {
		List<ConditionalCriteria> criteriaList = criteriaFor(Person.class).where(aaa()).greaterThanOrEqual("A").not()
				.lbrace().where(bbb()).eq("B").or().where(ccc()).eq("C").rbrace().build();
	...
	public void shouldBuildGroupedAndOr2() {
		ConditionalCriteria criteria = criteriaFor(Person.class).lbrace().withProperty(aaa()).eq("A").and()
				.withProperty(bbb()).eq("B").rbrace().or().lbrace().withProperty(ccc()).eq("C").and()
				.withProperty(ddd()).eq("D").rbrace().buildSingle();
		...
		assertEquals(Equal, ((ConditionalCriteria) leftAnd.getFirstOperant()).getOperator());
		assertEquals(Equal, ((ConditionalCriteria) leftAnd.getSecondOperant()).getOperator());
		...
		assertEquals(Equal, ((ConditionalCriteria) rightAnd.getFirstOperant()).getOperator());
		assertEquals(Equal, ((ConditionalCriteria) rightAnd.getSecondOperant()).getOperator());
	...
	public void shouldBuildGroupedAndOr3() {
		ConditionalCriteria criteria = criteriaFor(Person.class).where(aaa()).lessThan("A").and().where(bbb())
				.greaterThan("B").or().where(ccc()).ignoreCaseEq("C").and().where(ddd()).ignoreCaseLike("D")
				.buildSingle();
		...
		assertEquals("ccc", ((ConditionalCriteria) rightAnd.getFirstOperant()).getPropertyName());
		assertEquals("ddd", ((ConditionalCriteria) rightAnd.getSecondOperant()).getPropertyName());
		assertEquals(IgnoreCaseEqual, ((ConditionalCriteria) rightAnd.getFirstOperant()).getOperator());
		assertEquals(IgnoreCaseLike, ((ConditionalCriteria) rightAnd.getSecondOperant()).getOperator());
	}
	...
	public void shouldBuildGroupedAndOr4() {
		ConditionalCriteria criteria = criteriaFor(Person.class).where(aaa()).lessThan("A").and().where(bbb())
				.greaterThan("B").or().where(ccc()).ignoreCaseEq("C").and().where(ddd()).ignoreCaseLike("D")
				.where(eee()).isNotNull().buildSingle();
	...
	public void shouldBuildGroupedAndOr5() {
		ConditionalCriteria criteria = criteriaFor(Person.class).where(aaa()).lessThan("A").and().where(bbb())
				.greaterThan("B").or().where(ccc()).ignoreCaseEq("C").and().where(ddd()).ignoreCaseLike("D").or()
				.where(eee()).isNotNull().buildSingle();
		...
		assertEquals(LessThan, ((ConditionalCriteria) first.getFirstOperant()).getOperator());
		assertEquals(GreatThan, ((ConditionalCriteria) first.getSecondOperant()).getOperator());
		...
		assertEquals(IgnoreCaseEqual, ((ConditionalCriteria) second.getFirstOperant()).getOperator());
		assertEquals(IgnoreCaseLike, ((ConditionalCriteria) second.getSecondOperant()).getOperator());
	...
	public void shouldBuildGroupedAndOr6() {
		ConditionalCriteria criteria = criteriaFor(Person.class).lbrace().where(aaa()).eq("A").where(bbb()).eq("B")
				.rbrace().or().lbrace().where(ccc()).eq("C").where(ddd()).eq("D").rbrace().buildSingle();
	...
	public void shouldBuildImplicitInsideBraces() {
		ConditionalCriteria criteria = criteriaFor(Person.class).withProperty(aaa()).eq("X").or().lbrace()
				.withProperty(aaa()).eq("A").withProperty(bbb()).eq("B").withProperty(ccc()).greaterThan("C")
				.withProperty(ddd()).lessThan("D").rbrace().buildSingle();
	...
	public void shouldBuildExplicitInsideBraces() {
		ConditionalCriteria criteria = criteriaFor(Person.class).withProperty(aaa()).eq("X").or().lbrace()
				.withProperty(aaa()).eq("A").and().withProperty(bbb()).eq("B").and().withProperty(ccc())
				.greaterThan("C").and().withProperty(ddd()).lessThan("D").rbrace().buildSingle();
	...
	public void balancedBraceForWhereAndHaving() {
		try {
			ConditionalCriteria criteria = criteriaFor(Person.class).lbrace().where(aaa()).eq("A").having(bbb()).eq("B")
					.rbrace().buildSingle();
			fail("Have to fire exception");
		} catch (IllegalStateException ise) {
			assertEquals("withProperty()/where()/having() mixed inside braces (missing 1 rbrace)", ise.getMessage(),
					"Wrong message for where/having mixup");
			assertEquals("having", ise.getStackTrace()[1].getMethodName(), "Wrong method fired exception");
		}

		try {
			ConditionalCriteria criteria = criteriaFor(Person.class).lbrace().having(aaa()).eq("A").where(bbb()).eq("B")
					.rbrace().buildSingle();
			fail("Have to fire exception");
		} catch (IllegalStateException ise) {
			assertEquals("withProperty()/where()/having() mixed inside braces (missing 1 rbrace)", ise.getMessage(),
		...
		try {
			ConditionalCriteria criteria = criteriaFor(Person.class).lbrace().where(aaa()).eq("A").where(bbb()).eq("B")
					.rbrace().lbrace().having(aaa()).eq("A").having(bbb()).eq("B").rbrace().lbrace().having(aaa())
					.eq("A").where(ccc()).eq("B").rbrace() // where(ccc()) should fire exception
					.buildSingle();
			fail("Have to fire exception");
		} catch (IllegalStateException ise) {
			assertEquals("withProperty()/where()/having() mixed inside braces (missing 1 rbrace)", ise.getMessage(),
		...
		try {
			// This is OK
			List<ConditionalCriteria> criteria = criteriaFor(Person.class).lbrace().where(aaa()).eq("A").where(bbb())
					.eq("B").rbrace().lbrace().having(aaa()).eq("A").having(bbb()).eq("B").rbrace().lbrace()
					.where(aaa()).eq("A").where(ccc()).eq("B").rbrace().lbrace().having(aaa()).eq("A").having(bbb())
					.eq("B").rbrace().build();
		} catch (IllegalStateException ise) {
		...
		try {
			...
			List<ConditionalCriteria> criteria = criteriaFor(Person.class).lbrace().where(aaa()).eq("A").and()
					.where(bbb()).eq("B").rbrace().lbrace().having(aaa()).eq("A").and().having(bbb()).eq("B").rbrace()
					.lbrace().lbrace().where(aaa()).eq("A").and().where(ccc()).eq("B").rbrace().rbrace().lbrace()
					.lbrace().having(aaa()).eq("A").and().having(bbb()).eq("B").rbrace().rbrace().build();
		} catch (IllegalStateException ise) {
			fail("Exception fired: " + ise.getMessage());
		}
		...
		try {
			...
			List<ConditionalCriteria> criteria = criteriaFor(Person.class).lbrace().where(aaa()).eq("A").and()
					.where(bbb()).eq("B").rbrace().lbrace().having(aaa()).eq("A").and().having(bbb()).eq("B").rbrace()
					.lbrace().lbrace().where(aaa()).eq("A").and().where(ccc()).eq("B").rbrace().having(ddd())
					.isNotNull().rbrace() // having(ddd()) should fire exception
					.build();
			fail("Have to fire exception");
		} catch (IllegalStateException ise) {
			assertEquals("withProperty()/where()/having() mixed inside braces (missing 1 rbrace)", ise.getMessage(),
	...
	public static class PersonProperties {
		private static final PersonPropertiesImpl<Person> sharedInstance = new PersonPropertiesImpl<Person>(
				Person.class);
	...
	public static class AddressProperties {
		...
		// note that static methods are not generated in BasicType, since they can't be
		// root of the criteria
