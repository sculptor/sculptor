...
public class PagedResultTest {
	...
	public static Collection<Object[]> data() {
		return Arrays.asList(new Object[][]{{0, 0, 10, 0, 0, 1, 0, 0}, {0, 10, 10, 26, 3, 1, 3, 1},
				{1, 10, 10, 26, 3, 1, 3, 1}, {9, 10, 10, 26, 3, 1, 3, 1}, {10, 10, 10, 26, 3, 2, 3, 1},
	...
	void testPagedResult(int startRow, int rowCount, int pageSize, int totalRows, int additionalResultRows,
		...
		PagedResult<Object> pagedResult = new PagedResult<Object>(new ArrayList<Object>(), startRow, rowCount, pageSize,
				totalRows, additionalResultRows);
		...
		assertEquals(expectedAdditionalResultPages, pagedResult.getAdditionalResultPages(),
				"AdditionalResultPages wrong calculated");
	}
}
