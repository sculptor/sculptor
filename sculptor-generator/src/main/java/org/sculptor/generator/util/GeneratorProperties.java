...
public class GeneratorProperties {
	...
	private static final String DEFAULT_PROPERTIES_RESOURCE = System.getProperty("sculptor.defaultGeneratorPropertiesLocation",
	...
	private static void initDerivedDefaults(Properties defaultProperties) {
		...
		if (hasProjectNature("rcp")) {
			defaultProperties.setProperty("scaffold.operations", getProperty("scaffold.operations") + ",populateAssociations");
	...
	public static String getProperty(String propertyName) {
		...
		if (value == null) {
			throw new MissingResourceException("Property not found: " + propertyName, "GeneratorProperties", propertyName);
		}
		return value;
	}
